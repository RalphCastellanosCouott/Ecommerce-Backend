<div id="app">
    <style>
        /* Estilo CSS para la barra de navegación */
        .navbar {
            background-color: #6e7fdb !important; /* Cambia el fondo */
            position: fixed;
            top: 0;
            width: 100%;
        ...
        /* Añadir espacio en la parte superior del contenido para no cubrirlo con la barra fija */
        body {
            padding-top: 56px; /* Ajusta este valor si el tamaño de la barra cambia */
        }
    </style>
